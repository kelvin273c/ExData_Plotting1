...
plotfilename<-paste(getwd(),"plot1.png",sep="/")
png(plotfilename)
...
#plot one
hist(consumptiondata[twodays,"Global_active_power"],col="red",xlab="Global Active Power (kilowatts)",ylab="Frequency", main="Global Active Power")
